const CACHE_NAME = "ras-sudr-baz-v34";
const CORE = [
  ...
  "./assets/v21.js?v=21","./assets/v22.js?v=22","./assets/v23.js?v=23","./assets/v24.js?v=24","./assets/v25.js?v=25","./assets/v26.js?v=26","./assets/v27.js?v=27","./assets/v28.js?v=28","./assets/v29.js?v=29","./assets/v30.js?v=30","./assets/v31.js?v=31","./assets/v32.js?v=32","./assets/v34.js?v=34",
...
self.addEventListener('fetch',event=>{
  ...
  // App-page changes should feel native: every HTML page is pre-cached and returned
  // immediately. A network refresh happens silently after the response.
  if(req.mode==='navigate'){
    event.respondWith(navigateFast(req,event));
    return;
  }

  // Versioned scripts/styles and local assets are also cache-first. A new service
  // worker cache name ships every release, so updates still arrive automatically.
